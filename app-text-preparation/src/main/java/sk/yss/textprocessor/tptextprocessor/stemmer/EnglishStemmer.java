package sk.yss.textprocessor.tptextprocessor.stemmer;

/**
 * Stemmer, implementing the Porter Stemming Algorithm. <br />
 * 
 * The Stemmer class transforms a word into its root form. The input word can be provided a character at time (by calling add()), or at once by calling one of
 * the various stem(something) methods.
 *
 * Downloaded from: https://github.com/stanfordnlp/CoreNLP/blob/master/src/edu/stanford/nlp/process/Stemmer.java
 *
