package sk.yss.textprocessor.calculator;
...
public class TfIdfProcessor {
	...
	public static final double countTFIDF(int numberOfWordOccurencesInDocument, int numberOfAllWordsInExaminedDocument, int numberOfAllDocuments,
			int numberOfDocumentsWhereWordAppears) {
		return countTFIDF(countTF(numberOfWordOccurencesInDocument, numberOfAllWordsInExaminedDocument),
				countIDF(numberOfAllDocuments, numberOfDocumentsWhereWordAppears));
	}
